...
| `psp_result_data`    | Array   |               | For Adyen: `NotificationRequestItem` related to this transaction. Typically something like: `{"additionalData": {...}, "eventCode": "AUTHORISATION", "success": "true", ...}` |
...
| *for payment_instrument=\*, payment_service_provider=adyen:*    |
| ↳ `shopper_reference`*                                          | String  |            | Adyen Shopper Reference                                                                                                                                                                                                                                                                                                                                       |
| ↳ `stored_payment_method_id`*                                   | String  |            | Adyen Recurring Detail Reference                                                                                                                                                                                                                                                                                                                              |
| ↳ `merchant_account`*                                           | String  |            | Adyen Merchant Account, e.g. `GreenpeaceAT`                                                                                                                                                                                                                                                                                                                   |
| ↳ `psp_result_data`                                             | Array   |            | Adyen `NotificationRequestItem` related to this transaction (optional, required if this is a new Adyen Shopper Reference). Typically something like: `{"additionalData": {...}, "eventCode": "AUTHORISATION", "success": "true", ...}`                                                                                                                        |
| *for payment_instrument=RCUR, payment_service_provider=civicrm:* |
| ↳ `iban`*                                                       | String  |            | IBAN                                                                                                                                                                                                                                                                                                                                                          |
